...
def chat_audio_callback(msg: String) -> None:
    ...
    try:
        ...
        app._main_loop.create_task(app._send_text_tts("[mcp] yours.get_audio_play"), name="chat_audio_tts")
...
def audio_callback(msg: String) -> None:
    ...
    try:
        ...
        if not data:
            return
        play_text = f"请原样复述：{data}"
        app._main_loop.create_task(app._send_text_tts("[mcp] yours.get_audio_play"), name="audio_tts")
